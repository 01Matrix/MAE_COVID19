...
class PadPrompter(nn.Module):
    def __init__(self, args):
        ...
        self.base_size = input_size - pad_size*2
        self.pad_up = nn.Parameter(torch.randn([1, 3, pad_size, input_size]))
        self.pad_down = nn.Parameter(torch.randn([1, 3, pad_size, input_size]))
        self.pad_left = nn.Parameter(torch.randn([1, 3, input_size - pad_size*2, pad_size]))
        self.pad_right = nn.Parameter(torch.randn([1, 3, input_size - pad_size*2, pad_size]))
