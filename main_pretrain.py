...
def get_args_parser():
    ...
    parser.add_argument('--freeze_epochs', default=200, type=int)
    ...
    parser.add_argument('--output_dir', default='./MAE_COVID19_output_pretrain',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./MAE_COVID19_output_pretrain',
...
def main(args):
    ...
    # simple augmentation
    # dataset_train = COVID_CT_Dataset(os.path.join(args.data_path, 'train'), transform=transform_train)
    ...
    #     for param in model_without_ddp.named_parameters():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        #     param_groups = optim_factory.add_weight_decay(model_without_ddp, args.weight_decay)
        #     optimizer = torch.optim.AdamW(param_groups, lr=optimizer.param_groups[0]["lr"], betas=(0.9, 0.95))
        if args.distributed:
...
if __name__ == '__main__':
    ...
    # wandb.login()
    # wandb.init(config = args, project="MAE_COVID19_pretrain", entity="xxx", \
