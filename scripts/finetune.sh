...
OMP_NUM_THREADS=1 torchrun --nnodes=1 --nproc_per_node=$4 main_finetune.py \
        --model ${model} \
        --save_all \
        ...
        # --resume /home/hwxiao/mycodes/MAE_COVID19/outputs/output_finetune/finetune_with_data36_mae_pretrain_vit_large/8:1:1/CXC_seed42_bs64_b0.001_l0.75_w0.05_d0.1_r0.25_m0.8_c1.0_rb0_fb0_attnFalse_mlpFalse_biasFalse_FFT/checkpoint-74.pth
