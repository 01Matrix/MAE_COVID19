...
python main_finetune_txt_ddp.py --batch_size 256 --blr 0.0005 --layer_decay 0.65 --weight_decay 0.05 --drop_path 0.1 --reprob 0.25 --mixup 0.8 --cutmix 1.0 --tar CXC --model vit_base_patch16 --split_ratio 8:1:1 --finetune 
python main_finetune_txt_ddp.py --batch_size 256 --blr 0.001 --layer_decay 0.75 --weight_decay 0.05 --drop_path 0.2 --reprob 0.25 --mixup 0.8 --cutmix 1.0 --tar CXC --model vit_large_patch16 --split_ratio 8:1:1 --finetune /home/hwxiao/medical_pretrained_models/MAE/data13_mae_pretrain_vit_large.pth
