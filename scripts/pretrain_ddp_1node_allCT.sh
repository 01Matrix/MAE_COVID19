...
OMP_NUM_THREADS=1 torchrun --nnodes=1 --nproc_per_node=8 main_pretrain_ddp.py \
                        ...
                        --resume /home/hwxiao/mycodes/MAE_COVID19/outputs/output_pretrain/base_CHE_CCT_C1920_CAR_CCS_C1000_CIC_MRA_MRB_S_orig_SIRM_CXC_L_orig_CC_orig_CHAOSCT_DL_KITS_LIDC_LITS_MMWHS_VERSE_LYMPH_pretrain/checkpoint-350.pth